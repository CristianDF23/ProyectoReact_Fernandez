        ...
        return (
            <section className="container mx-auto mt-8 px-auto flex gap-6 h-screen rounded-lg border">
                ...
                <div className="w-full h-full bg-indigo-900 rounded-r-lg overflow-auto py-10 px-7">
                    {items.map((item) => (
                        <div key={item.id} className="flex justify-between gap-2 py-3 border-b w-full mb-6">
                            <div className="flex">
                                <img className="w-24 rounded-lg" src={item.imageOne} alt="" />
                                <div className="py-2 px-2 flex flex-col gap-1">
                                    <h2 className="text-white font-bold">{item.model}</h2>
                                    <h3 className="text-indigo-400 font-bold">Cantidad:</h3>
                                </div>
                            </div>
                            <div className="flex flex-col justify-between">
                                <h4 className="text-white font-bold">$ {item.price.toLocaleString()}</h4>
                                <button className="ml-10"><svg className="w-5 h-5 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 20">
                    ...
                    <div className="flex flex-col gap-3 mb-4">
                        <div className="flex justify-between">
                            ...
                            <h3 className="text-indigo-400 font-bold">$ 785</h3>
                        </div>
                        <div className="flex justify-between">
